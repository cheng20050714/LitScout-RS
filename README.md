...
中文调研主题
  ...
  -> 可选：SemanticScholar / DBLP 执行 Stage A 学术扩源
...
# 可选；开启 --academic-extra 时可提升 Semantic Scholar 配额
...
- 默认数据源仍限定为 GitHub 和 arXiv；`--academic-extra` 可显式启用 Semantic Scholar 与 DBLP。
